...
@interface EStreamGiftSelectionHolder ()
...
@implementation EStreamGiftSelectionHolder
...
{
//    C(self.context.view, IStreamView, showGiftSelectionView:false);
    
    if (_selectedItem) {
        C(self.context.presenter, IStreamPresenter, sendGiftWithIndex:(int)_selectedItem.tag);
    }
}

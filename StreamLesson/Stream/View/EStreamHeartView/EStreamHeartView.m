...
@interface EStreamHeartView ()
@property (nonatomic, strong) UIImage*                                      imgHeart;
@property (nonatomic, assign) LikeChannelMessageColorType                   curHeartType;

@end

@implementation EStreamHeartView

- (instancetype)init
{
    self = [super init];
    if (self) {
        _curHeartType = [LikeChannelMessage getRandomHeartColor];
    }
    return self;
}
...
- (void)fireHeart:(NSNumber*)colorId {
    ...
    self.imgHeart = [LikeChannelMessage getHeartImageByType:colorId.intValue];
...
{
    int LikeChannelMessageColorType = [LikeChannelMessage getRandomHeartColor];
    return [LikeChannelMessage getHeartImageByType:LikeChannelMessageColorType];
}

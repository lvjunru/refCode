...
#import "EStreamTextView.h"
#import "EStreamBulletSwitch.h"
...
@interface EStreamInputView () <UITextFieldDelegate, EStreamBulletSwitchDelegate>

@property (nonatomic, strong) EStreamBulletSwitch *switchBullet;
@property (nonatomic, strong) EStreamTextView *inputTextView;
...
@implementation EStreamInputView
...
- (void)buildInputView
{
    ...
    _textViewHeight = 36;
    self.switchBullet = [[EStreamBulletSwitch alloc] initWithFrame:CGRectMake(leftPadding, (self.bounds.size.height - _textViewHeight)/2, width, _textViewHeight)];
    ...
    self.inputTextView = [[EStreamTextView alloc] init];
